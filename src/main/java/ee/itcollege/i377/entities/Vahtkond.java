...
public class Vahtkond implements Serializable {
    ...
    public static List<Vahtkond> findAllVahtkonds() {
        return entityManager().createQuery("SELECT o FROM Vahtkond o WHERE o.sulgeja IS NULL", Vahtkond.class).
        		getResultList();
    }
    
    public static long countVahtkonds() {
        return entityManager().createQuery("SELECT COUNT(o) FROM Vahtkond o WHERE o.sulgeja IS NULL", Long.class).
        		getSingleResult();
    }
